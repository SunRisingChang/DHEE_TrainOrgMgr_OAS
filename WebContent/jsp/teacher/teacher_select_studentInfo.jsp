...
<body>
	<div id="div1">
		<div id="top">
			<div id="top1_1">
				<div class="top1_2">项目</div>
				<div class="top1_3">
					<input type="text" id="classes" name="" class="lay1" />
				</div>
				<div class="top1_2">班次</div>
				<div class="top1_3">
			...
			<table class="table table-hover" id="table1" pages="0">
				<thead>
					<tr>
						...
						<th style="text-align: center;">开班时间</th>
				...
				<tbody>
					<tr>
						<td style="text-align: center;width: 8px;">3</td>
						<td style="text-align: center;width: 140px;">CISAW-软件安全开发</td>
						<td style="text-align: center;width: 50px;">第11期</td>
						<td style="text-align: center;width: 190px;">2016年1月2日-2016年1月6日</td>
						<td style="text-align: center;width: 75px;">大连华信</td>
						<td style="text-align: center;width: 55px;">李雷</td>
						<td style="text-align: center;width: 8px;">110123199011203548</td>
						<td style="text-align: center;width: 8px;">13801017788</td>
						<td style="text-align:center;width: 71px;"><q id="xiangqing" class="q1" rowid="'+index+'">详情</q><q id="shanchu" class="q2" rowid="'+value.id+'">删除</q></td>
					</tr>
				</tbody>
			</table>
		</div>
